...
func main() {
	...
	fmt.Println("}")
	fmt.Println()
	fmt.Println("// Get protection status")
	fmt.Println("protection, _ := battery.GetProtectionStatus(ctx)")
	fmt.Println("if protection.OverVoltage {")
	fmt.Println("    fmt.Println(\"Warning: Over voltage protection active!\")")
	fmt.Println("}")
	fmt.Println("```")
	fmt.Println()
